...
public class Gestor_EstadiaTest {
    ...
    //Test buscarEstadia
    //test actualizar y retornar estadia
    @Test
    void buscarEstadia_deberiaActualizarYRetornarEstadia_siEsActiva() {
        ...
        Estadia resultado = gestorEstadia.buscarEstadia(NUMERO_HABITACION.toString(), HORA_MINUTO_SALIDA);
    ...
    void buscarEstadia_deberiaLanzarExcepcion_siHabitacionNoExiste() {
        ...
        EntityNotFoundException exception = assertThrows(EntityNotFoundException.class, () -> {
            gestorEstadia.buscarEstadia("999", HORA_MINUTO_SALIDA);
        });
    ...
    void buscarEstadia_deberiaLanzarExcepcion_siNoHayEstadiaActiva() {
        ...
        EntityNotFoundException exception = assertThrows(EntityNotFoundException.class, () -> {
            gestorEstadia.buscarEstadia(NUMERO_HABITACION.toString(), HORA_MINUTO_SALIDA);
        });
    ...
    //test lanza excepcion si hora salida invalida
    @Test
    void buscarEstadia_deberiaLanzarException_siHoraSalidaEsInvalida() {

        assertThrows(java.time.format.DateTimeParseException.class, () -> {
            gestorEstadia.buscarEstadia(NUMERO_HABITACION.toString(), "15-30");
        });
    ...
    void buscarEstadia_deberiaLanzarException_siNumeroHabitacionNoEsNumero() {
        assertThrows(NumberFormatException.class, () -> {
            gestorEstadia.buscarEstadia("A101", HORA_MINUTO_SALIDA); 
        });
        verify(habitacionDaoDB, never()).buscarPorNumero(anyLong());
        verify(estadiaDaoDB, never()).actualizar(any(Estadia.class));
    }
